...
sns.violinplot(x="Model", y="AUC", data=df, palette=palette, inner_kws=dict(box_width=15, whis_width=2, color=".8"))
# sns.stripplot(x="Model", y="AUC", data=df, color="black", size=3, jitter=True, alpha=0.7)
