...
import time
import pickle
from utils.tools import plot_loss_acc, self_training, facility_location_loss
...
for fold, (train_idx, test_idx) in enumerate(kf.split(all_data)):
    ...
    for epoch in tqdm(range(1, args.epoch + 1), desc='Training'):
        ...
        total_train_loss, train_samples = train(model, train_loader, device, optimizer, criterion, epoch, args)
